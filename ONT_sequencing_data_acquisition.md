...
cp /home/groups/schumer/shared_bin/Lab_shared_scripts/sub_ont_basecall_dorado.sh . #then edit path in this script to your conda nanopore env
...
If you want to map reads to a reference, you can use `dorado aligner` to map the combined ubam (or fastq.gz) file to an existing assembly.
